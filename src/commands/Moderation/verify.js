...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((command) =>
      command
        .setName("bypass")
        .setDescription("Bypasses specified user from the verification process.")
        .addUserOption((option) =>
          option
            .setName("user")
            .setDescription("Specified user will bypass the verification process.")
            .setRequired(true)
        )
    ),
    ...
    switch (sub) {
      case "setup":
        ...
        const message =
          ...
          "This server is protected by ServerCaptcha. To verify please click the button below and enter the captcha!";
        ...
        if (data)
          ...
          const verify = new EmbedBuilder()
            ...
            .setFooter({ text: `ServerCaptcha by crexy_` })
            .setImage(`https://cdn.discordapp.com/attachments/1117069864985690202/1122179072341049495/footer.png`)
        ...
        if (!data)
          ...
          if (data.Verified.includes(displayuser.id))
            ...
            try {
              ...
              return await interaction.reply({
                content: `I **couldn't** give ${displayuser} their **verification** role! Check my **permissions** and **role position** and try again. If This Not Works Please Feel Free To Send Dm To crexy_`,
                ephemeral: true,
              });
            }
        ...
        if (!data)
          ...
          if (!data.Verified.includes(displayuser1.id))
            ...
            try {
              ...
              return await interaction.reply({
                content: `I **couldn't** remove ${displayuser1}'s **verification** role! Check my **permissions** and **role position** and try again. If This Not Works Please Feel Free To Send Dm To crexy_`,
                ephemeral: true,
              });
            }
